...
double precision, parameter :: dt   = 1.0d-10, &
                               tmax = 0.3d0 
...
double precision, parameter :: S    = 1.00d0 + 1.1d-2! saturation 
! 1[J] = 1[Pa*m^3]
...
print*,"Fk = ", Fk, "[s/m^2]"
print*,"Fd = ", Fd, "[s/m^2]"
print*,"m = ", Rhow * 4/3 * pi * r**3 * 1.0d-3, "[g]" 
print *, "------------------------------------------------"
            !########## Preparing file writing #########
open(unit = 10, file = "./dg.dat", status = "replace", action = "readwrite")
print*, "Opening file : dg.dat"
